...
<table width="960" border="0" align="center" cellpadding="5" cellspacing="0">
  <tbody>
      ...
      <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
          <tbody>
            ...
            <tr>
              ...
              <td>{{$info->info_year}}年{{$info->info_month}}月{{$info->info_day}}日17{{$info->info_hour}}11{{$info->info_minute}}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>@if($info->info_type == 3){!! html_entity_decode($info->info3_contents) !!}@endif</td>
            </tr>
            <tr>
              <td width="15%" class="col_3">画像</td>
              <td>@if(!empty($info->info3_img))
				<a href="{{ asset('public') }}{{$info->info3_img}}" target="_blank" >表示</a>
				@else
				なし
				@endif</td>
            </tr>
            ...
            <tr>
              ...
              <td>@if(!empty($info->info3_file))
				<a href="{{ asset('public') }}{{$info->info3_file}}" target="_blank" >表示</a>
				@else
				なし
				@endif</td>
            </tr>
    ...
    <tr>
      <td align="center"><input type="button" name="button2" id="button2" value="変更する（確認済み）" onClick="location.href='{{route('backend.infos.edit_save', $info_id)}}'">
      <input type="button" name="button" id="button" value="もどる" onClick="location.href='{{route('backend.infos.edit_back', $info_id)}}'"></td>
    </tr>
    <tr>
      <td align="center">&nbsp;</td>
    </tr>
