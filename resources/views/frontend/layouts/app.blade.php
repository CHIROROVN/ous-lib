...
<title>岡山理科大学図書館</title>
<meta name="format-detection" content="telephone=no">
<link href="{{ asset('') }}public/common/css/import.css" rel="stylesheet" type="text/css" media="all">
<link href="{{ asset('') }}public/common/css/slider-pro.min.css" rel="stylesheet" type="text/css" media="all">
<link href="{{ asset('') }}public/common/css/cal.css" rel="stylesheet" type="text/css" media="all">
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
<script type="text/javascript" src="{{ asset('') }}public/common/js/function.js"></script>
<script type="text/javascript" src="{{ asset('') }}public/common/js/jquery.sliderPro.min.js"></script>
<script type="text/javascript" src="{{ asset('') }}public/common/js/top.js"></script>
</head>
<body id="pagetop">
<header>
  ...
  <ul>
    ...
    <li><a href="{{ asset('') }}zousyo.html"><img src="{{ asset('') }}public/common/image/gnavi-03_off.png" width="140" height="56" alt="蔵書検索"></a>
      <ul>
        ...
        <li><a href="https://op00.lib.ous.ac.jp/mylimedio/loginPage.do" target="_blank">My Library</a></li>
        <li><a href="http://oudan.libnet.pref.okayama.jp/gf/cgi/start-jp" target="_blank">岡山県図書館横断検索</a></li>
        <li><a href="https://ci.nii.ac.jp/books/?l=ja" target="_blank">全国の大学図書館</a></li>
    ...
    <li><a href="{{ asset('') }}db.html"><img src="{{ asset('') }}public/common/image/gnavi-04_off.png" width="140" height="56" alt="データベース"></a>
      <ul>
        ...
        <li><a href="https://scholar.google.com/scholar?hl=ja&lr=" target="_blank">Google Scholar</a></li>
        <li><a href="http://www.rikanenpyo.jp/member/?module=Member&action=Login" target="_blank">理科年表Web</a></li>
        <li><a href="https://www.chem-reference.com/" target="_blank">化学書資料館</a></li>
        <li><a href="https://database.asahi.com/index.shtml" target="_blank">聞蔵Ⅱ</a></li>
        <li><a href="internet.html#DB">その他</a></li>
    ...
    <li><a href="{{ asset('') }}denshi.html"><img src="{{ asset('') }}public/common/image/gnavi-05_off.png" width="140" height="56" alt="電子資料"></a>
      <ul>
        ...
        <li><a href="http://search.proquest.com/" target="_blank">Proquest</a></li>
        <li><a href="http://www.jstage.jst.go.jp/browse/-char/ja" target="_blank">J-Stage</a></li>
        <li><a href="http://bizboard.nikkeibp.co.jp/academic/" target="_blank">日経の雑誌</a></li>
...
<div id="footer">
  <footer>
    <p><img src="{{ asset('') }}public/common/image/footer_logo.gif" width="326" height="47"></p>
    <address>
...
<div id="copy">
  <p>Copyright &copy; Okayama University of Science Library. All rights reserved.</p>
</div>
</body>
</html>